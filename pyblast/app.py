...
urls = (
    str('{}'.format(settings.get('BASE_URL'))), 'index',
    str('{}results/(.*)/'.format(settings.get('BASE_URL'))), 'results',
    str('{}run/(.*)/'.format(settings.get('BASE_URL'))), 'start_blast',
    str('{}status/(.*)/'.format(settings.get('BASE_URL'))), 'status',
    str('{}sequence/(.*)/(.*)/'.format(settings.get('BASE_URL'))), 'sequence',
    str('{}multisequence'.format(settings.get('BASE_URL'))), 'multisequence',
    )
